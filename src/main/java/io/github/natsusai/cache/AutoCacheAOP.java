...
public class AutoCacheAOP {
    ...
    public Object process(ProceedingJoinPoint point) throws Throwable {
        ...
        String cacheName = KeyGenerator.generateCacheName(appName, clazzName, methodName);
        ...
        Object result = Optional.ofNullable(cache).map(c -> c.get(cacheKey)).map(Cache.ValueWrapper::get).orElse(null);
        if (result == null) {
